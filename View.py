...
def visualize_subgraph(G, center_node, depth=1):
    ...
    decade_nodes = [n for n, d in subgraph.nodes(data=True) if d.get('type') == 'decade']
    ...
    nx.draw_networkx_nodes(subgraph, pos, nodelist=decade_nodes, node_color='purple', node_size=300, alpha=0.8, label='Decades')
